      ...
      <a href="login/login_name.php">로그인</a>  <a href="index.php">Home</a>
        ...
        <nav id="top_menu2">
          <ul>
            ...
            <div class="nor" onclick="location.href='free.php?bid=free';">    <li>자유게시판</li></div>
...
<div class="str">    
 <td style="text-align:left;"> 
   <div class=<?=$side_bord?> onclick="location.href='free.php?bid=<?=$str?>&pages=<?=$pages?>&mainbid=free'"><?php echo"$str"?></div>
 </td>
...
?>
        ...
        <div id="">
          <img id ="img"src="img/free.png" alt="">
        </div>
...
<?php		
		if($firstLink>1){
?>
			<a class="nones" href="free.php?bid=<?=$bid?>&page=<?= $firstLink -1 ?>"> 이전 </a>
<?php
	 }
		
		for ($i=$firstLink; $i <= $lastLink; $i++){		
?>
			<a class="nones" href="free.php?bid=<?=$bid?>&page=<?=$i?>"> <?=($i == $page) ? "<u>$i</u>" : $i?> </a>
<?php
		}
		
		if($lastLink<$numPage){
?>
			<a class="nones" style= 'margin:0;' href="free.php?bid=<?=$bid?>&page=<?=$lastLink +1?>"> 다음 </a>
<?php
		}
